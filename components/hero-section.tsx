    ...
    <>
      ...
      <main className="relative overflow-hidden bg-white min-h-screen flex flex-col">
        ...
        <section className="relative z-10 flex flex-col items-center justify-center flex-1 px-6 pt-24 pb-16 text-center">
          ...
          >
            Stop Running Your Center{" "}
            <span className="text-emerald-500">Out of a Spreadsheet.</span>
          </motion.h1>
          ...
          >
            Thetix is scheduling, attendance tracking, and parent communication — 
            all in one tool built specifically for tutoring center directors.
          </motion.p>
          ...
          >
            Built by someone who worked in tutoring centers and lived this problem firsthand.
          </motion.p>
          ...
          >
            ...
            >
              <Link href="#waitlist" className="flex items-center gap-3" onClick={() => trackEvent("hero_cta_click")}>
                Join the Waitlist <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <p className="text-xs text-slate-400 font-medium">Free during early access. No credit card required.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">— Tutoring Center Director</p>
          </motion.div>
