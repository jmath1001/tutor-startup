...
export default function CallToAction({ content }: { content?: any }) {
  const defaultContent = {
    headline: "Join the pilot. Validate outcomes in your center.",
    description: "Start with your biggest pain points first: scheduling chaos, no-shows, and fragmented records. Thetix combines constraint-aware autoscheduling with one centralized operating layer.",
    cta: "Join Pilot",
    secondary: "Book Demo",
    perks: [
      {
